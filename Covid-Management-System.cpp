// COVID19 MANAGEMENT SYSTEM USING FILE HANDLING IN CPP - (AYUSH RAJPUT)
...
void covid_management::menu()
{
    ...
    case 3:
        system("cls");
        cout << "\n\n\t\t\t COVID19 MANAGEMENT SYSTEM - BY AYUSH RAJPUT";
        Sleep(10);
        exit(0);
    default:
...
void covid_management::admin_password()
{
    ...
    cout << "\n\n\t\tEnter Valid Captcha: ";
    cin >> capta;
    if ((strcmp(a_name, "ayush") == 0) && (strcmp(a_password, "ar1234") == 0) && (capt == capta))
    {
        cout << "\n\n\n\t\t\t\t\t| Verfiying ADMIN |\n\t\t\t\t\t";
        for (int a = 1; a < 8; a++)
        {
